export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <img src="./assets/user-image.png" alt="" className="rounded-full w-32" />
            <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I&apos;m Doha Emad
                <img src="./assets/hand-icon.png" alt="" className="w-6 mb-1" />
            </h3>
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">frontend web developer </h1>
            <p className="max-w-2xl mx-auto font-Ovo">  I am a passionate Front-End Developer and Computer Science student based in Egypt, specializing in building responsive and user-friendly web applications using modern technologies.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/Doha_Emad_2026_CV.pdf" download
