export default function About() {
    ...
    const data = [
        ...
        },
        {
            ...
            description: 'Bachelor of Computer Science (Information Systems) – Assiut University, 2026',
        },
        {
            name: 'Projects',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">  I am a passionate Front-End Developer and Computer Science student specializing in Information Systems. I enjoy building responsive and user-friendly web applications using modern technologies like React.js and JavaScript. I focus on writing clean, scalable code and delivering seamless user experiences.</p>
